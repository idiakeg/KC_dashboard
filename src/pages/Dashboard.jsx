        ...
        <div className="dashboard">
            <div className="dashboard_sidebar_container">
                <div className="dashboard_head">
                    ...
                    <div className="dashboard_head_aside">
                        <span className="dashboard_title">Dashboard</span>
                        <span className="dashboard_version">v.01</span>
                    </div>
                </div>
                <ul className="sidebar_links_container">
                    <li className="solo_desc">
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                    ...
                    <li
                        className={`${
                            activeStates.product ? "active_sidebar" : ""
                        }`}
                        onClick={() => handleActiveState("product")}
                    >
                        <Link>
                            <svg
                                width="24"
                    ...
                    <li
                        onClick={() => handleActiveState("customers")}
                        className={`${
                            activeStates.customers ? "active_sidebar" : ""
                        }`}
                    >
                        <Link>
                            <svg
                    ...
                    <li
                        className={`${
                            activeStates.income ? "active_sidebar" : ""
                        }`}
                        onClick={() => handleActiveState("income")}
                    >
                        <Link>
                            <svg
                                width="24"
                    ...
                    <li
                        onClick={() => handleActiveState("promote")}
                        className={`${
                            activeStates.promote ? "active_sidebar" : ""
                        }`}
                    >
                        <Link>
                            <svg
                    ...
                    <li
                        onClick={() => handleActiveState("help")}
                        className={`${
                            activeStates.help ? "active_sidebar" : ""
                        }`}
                    >
                        <Link>
                            <svg
